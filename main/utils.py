...
def numpyArrayToCoordinates(array, dimensions):
	return (dimensions[0] * array[0], dimensions[1] * array[1])

def coordinatesToNumpyArray(tuple, dimensions):
	return numpy.array([tuple[0] / dimensions[0], tuple[1] / dimensions[1]])
